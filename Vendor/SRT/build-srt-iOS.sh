...
srt() {
  ...
  make
  install_name_tool -id "@executable_path/Frameworks/libsrt.1.4.4.dylib" libsrt.1.4.4.dylib
  popd
}
...
cp ./build/iOS/arm64/version.h srt/srtcore/version.h
